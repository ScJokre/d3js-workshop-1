...
const color = /* TODO: Your code here */d3.scaleOrdinal(d3.schemeCategory10).domain(stocks.map(s => s.name));
...
const xAxis = d3.axisBottom(x).ticks(d3.utcYear.every(1)).tickFormat(d3.utcFormat('%Y'));// TODO: Define X axis, format ticks to show only years 
...
const yAxis = d3.axisLeft(y).ticks(10).tickFormat(d => `$${d.toFixed(2)}`);// TODO: Define Y axis, format ticks to show $ sign
...
svg.append('text')
    ...
    .attr('y', -20/* TODO: put the title above the chart */)
    .attr('text-anchor', 'middle')
    .style('font-size', '18px')
    .style('font-weight', 'bold')
    .text('Stock Closing Prices Over Time (AAPL, GOOG, AMZN)');
...
svg.append('text')
    ...
    .attr('y', height + 40/* TODO: put the label below x-xis */)
    .attr('text-anchor', 'middle')
...
svg.append('text')
    ...
    .attr('y', -60/* TODO: put the label to the left of y-axis */)
    .attr('text-anchor', 'middle')
    .style('font-size', '14px')
